...
<head>
    ...
    <title>Регистрация | ZENTECH</title>
...
<body class="font-sans antialiased bg-[#f8fafc]">
    ...
    <div class="min-h-screen flex flex-col items-center justify-center px-4 py-12">
        ...
        <div class="w-full max-w-[480px] bg-white rounded-[3rem] shadow-[0_20px_50px_rgba(0,0,0,0.05)] border border-zen-light p-10 md:p-12">
            <div class="text-center mb-8">
                <h2 class="text-3xl font-black text-zen-dark uppercase tracking-tight">Создать аккаунт</h2>
                <p class="text-gray-400 text-sm mt-2">Присоединяйтесь к сообществу ZenTech</p>
            </div>
            ...
            <form method="POST" action="{{ route('register') }}" class="space-y-5">
                ...
                <div>
                    <label class="block text-[10px] font-bold text-gray-400 uppercase tracking-[0.2em] mb-2 ml-4">Ваше имя</label>
                    <input type="text" name="name" :value="old('name')" required autofocus 
                        class="w-full bg-gray-50 border-2 border-transparent rounded-[1.5rem] py-4 px-6 focus:bg-white focus:border-zen-base focus:ring-0 transition-all duration-300 text-zen-dark font-medium placeholder-gray-300"
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                        <label class="block text-[10px] font-bold text-gray-400 uppercase tracking-[0.2em] mb-2 ml-4">Повторите</label>
            ...
            <div class="mt-10 pt-8 border-t border-gray-50 text-center">
                <p class="text-gray-400 text-xs font-bold uppercase tracking-widest mb-4">Уже есть аккаунт?</p>
                <a href="{{ route('login') }}" 
